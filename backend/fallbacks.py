...
SITES = [
    ...
    },
    {
        ...
        "tags": ("restless", "anxious", "foggy", "numb"),
    },
    {
        "name": "Sandspiel",
    ...
    },
    {
        ...
        "tags": ("anxious", "burnt out", "foggy", "numb"),
    },
    {
        "name": "Rainy Mood",
        "url": "https://www.rainymood.com",
        "tags": ("burnt out", "anxious", "numb"),
    },
    {
        "name": "Atlas Obscura",
...
_MOOD_ALIASES = (
    (("burnt out", "burned out", "burnout", "exhausted", "drained", "tired"), "burnt out"),
...
FALLBACK_PACKS = {
    "burnt out": [
        ...
        {
            "title": "Mix a quiet room",
            "micro_action": "Slide one rain or fire slider up. Listen for two minutes. Close it.",
            "why": "A sound you chose is gentler than another notification.",
            "image_prompt": "illustration of headphones on a linen cushion in morning light, plants, no text",
            "site_name": "A Soft Murmur",
            "site_why": "Build a calm room in one click. No account.",
        },
        {
        ...
        {
            "title": "Let it rain",
            "micro_action": "Press play once. Stare out a real or imagined window until your shoulders drop.",
            "why": "Steady rain is a background that never asks for a reply.",
            "image_prompt": "illustration of a sealed cream envelope on a sunlit stoop, wildflowers, no text",
            "site_name": "Rainy Mood",
            "site_why": "One button. Endless rain. No signup.",
        },
        {
    ...
    "restless": [
        ...
        {
            "title": "Tap a color symphony",
            "micro_action": "Press any key or tap the screen ten times. Stop when it makes you smile once.",
            "why": "Play without a scoreboard is motion for restless hands.",
            "image_prompt": "cheerful illustration of language flashcards fanned on a kitchen table, no text",
            "site_name": "Patatap",
            "site_why": "Instant sound and color. No streak to protect.",
        },
        {
            "title": "Pour some sand",
            "micro_action": "Drop sand in one corner until a small hill forms. Close the tab.",
            "why": "A tiny world you build beats another half-swipe.",
            "image_prompt": "clean illustration of a single white chess knight on a sunlit wooden table, no text",
            "site_name": "Sandspiel",
            "site_why": "Physics sandbox. Open and play.",
        },
        {
    ...
    "bored": [
        ...
        {
            "title": "Pour colored sand",
            "micro_action": "Change the sand color once. Fill one corner of the screen. Stop.",
            "why": "A small sensory loop is a cleaner hit than another meme.",
            "image_prompt": "friendly illustration of a chalkboard with a single simple diagram, plants, no text",
            "site_name": "Thisissand",
            "site_why": "Click and pour. Nothing to enroll in.",
        },
        {
    ...
    "foggy": [
        {
            "title": "Pour some sand",
            "micro_action": "Drop one element on the grid. Watch it settle. Add one more. Stop.",
            "why": "Watching something fall into place is easier than starting a task list.",
            "image_prompt": "clean illustration of a single white chess knight on a sunlit wooden table, no text",
            "site_name": "Sandspiel",
            "site_why": "Open the page. The toy is already there.",
        },
        {
            "title": "Tap a color symphony",
            "micro_action": "Press keys or tap until one sound makes you breathe out. Then leave.",
            ...
            "site_name": "Patatap",
            "site_why": "Instant play. No account wall.",
        },
        {
        ...
        {
            "title": "Pour colored sand",
            "micro_action": "Pick a new sand color. Fill one small patch. That is enough.",
            ...
            "site_name": "Thisissand",
            "site_why": "One click and you are already doing something.",
        },
        {
    ...
    "anxious": [
        ...
        {
            "title": "Mix a quiet room",
            "micro_action": "Turn up rain or wind one notch. Sit with it for two minutes.",
            "why": "A voice-free soundscape stays in one place — safer than a feed that jumps.",
            "image_prompt": "illustration of a cushion by a window with soft curtains, morning, no text",
            "site_name": "A Soft Murmur",
            "site_why": "Slide the sliders. No app download required.",
        },
        {
    ...
    "numb": [
        ...
        {
            "title": "Let it rain",
            "micro_action": "Hit play. Listen until you notice one real sound in your room too.",
            "why": "Layered calm can thaw a flat day without demanding joy.",
            "image_prompt": "illustration of a handwritten letter and a dried flower on linen, no text",
            "site_name": "Rainy Mood",
            "site_why": "Rain on loop. Open tab, press play, done.",
        },
        {
